...
public class FuncionarioControle {
	...
	@GetMapping("/cadastroFuncionario") //Para chamar a funcao cadastro funcionario 
	public ModelAndView cadastrar(Funcionario funcionario) {
		
		ModelAndView mv = new ModelAndView("administrativo/funcionarios/cadastro"); //Caminho de pasta html
